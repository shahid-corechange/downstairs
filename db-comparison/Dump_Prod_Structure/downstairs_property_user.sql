...
CREATE TABLE `property_user` (
  ...
  KEY `property_user_property_id_foreign` (`property_id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=1958 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
-- Dump completed on 2025-10-27  8:07:57
