...
CREATE TABLE `user_settings` (
  ...
  KEY `user_settings_value_index` (`value`),
  KEY `user_settings_type_index` (`type`),
  CONSTRAINT `user_settings_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=12580 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
-- Dump completed on 2025-10-27  8:07:56
