...
CREATE TABLE `price_adjustments` (
  ...
  PRIMARY KEY (`id`),
  KEY `price_adjustments_causer_id_foreign` (`causer_id`),
  CONSTRAINT `price_adjustments_causer_id_foreign` FOREIGN KEY (`causer_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
