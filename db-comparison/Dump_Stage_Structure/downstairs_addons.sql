...
CREATE TABLE `addons` (
  ...
  `credit_price` smallint unsigned NOT NULL,
  ...
  `color` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '#718096',
...
-- Dump completed on 2025-10-27  8:18:30
