...
CREATE TABLE `properties` (
  ...
  PRIMARY KEY (`id`),
  KEY `properties_address_id_foreign` (`address_id`),
  KEY `properties_property_type_id_foreign` (`property_type_id`),
  KEY `properties_membership_type_index` (`membership_type`),
  CONSTRAINT `properties_address_id_foreign` FOREIGN KEY (`address_id`) REFERENCES `addresses` (`id`) ON DELETE CASCADE,
...
) ENGINE=InnoDB AUTO_INCREMENT=1844 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
