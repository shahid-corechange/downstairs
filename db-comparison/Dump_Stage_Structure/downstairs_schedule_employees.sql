...
CREATE TABLE `schedule_employees` (
  ...
  `start_ip` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `start_at` timestamp NULL DEFAULT NULL,
  `end_latitude` decimal(10,2) DEFAULT NULL,
  `end_longitude` decimal(10,2) DEFAULT NULL,
  `end_ip` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `schedule_employees_user_id_foreign` (`user_id`),
  KEY `schedule_employees_work_hour_id_foreign` (`work_hour_id`),
  KEY `schedule_employees_status_index` (`status`),
...
) ENGINE=InnoDB AUTO_INCREMENT=327231 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
