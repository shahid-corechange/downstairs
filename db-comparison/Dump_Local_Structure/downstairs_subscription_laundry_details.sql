...
CREATE TABLE `subscription_laundry_details` (
  ...
  PRIMARY KEY (`id`),
  KEY `subscription_laundry_details_delivery_property_id_foreign` (`delivery_property_id`),
  KEY `subscription_laundry_details_delivery_team_id_foreign` (`delivery_team_id`),
  KEY `subscription_laundry_details_laundry_preference_id_foreign` (`laundry_preference_id`),
  KEY `subscription_laundry_details_pickup_property_id_foreign` (`pickup_property_id`),
  KEY `subscription_laundry_details_pickup_team_id_foreign` (`pickup_team_id`),
  KEY `subscription_laundry_details_store_id_foreign` (`store_id`),
...
--
-- Dumping data for table `subscription_laundry_details`
--

LOCK TABLES `subscription_laundry_details` WRITE;
/*!40000 ALTER TABLE `subscription_laundry_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `subscription_laundry_details` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-10-27  7:59:27
