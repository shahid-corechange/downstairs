...
CREATE TABLE `productables` (
  ...
  CONSTRAINT `productables_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE
...
LOCK TABLES `productables` WRITE;
/*!40000 ALTER TABLE `productables` DISABLE KEYS */;
/*!40000 ALTER TABLE `productables` ENABLE KEYS */;
UNLOCK TABLES;
