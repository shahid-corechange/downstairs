...
--
-- Table structure for table `order_fixed_prices`
--

DROP TABLE IF EXISTS `order_fixed_prices`;
...
CREATE TABLE `order_fixed_prices` (
  ...
  PRIMARY KEY (`id`),
  KEY `order_fixed_prices_fixed_price_id_foreign` (`fixed_price_id`),
...
--
-- Dumping data for table `order_fixed_prices`
--

LOCK TABLES `order_fixed_prices` WRITE;
/*!40000 ALTER TABLE `order_fixed_prices` DISABLE KEYS */;
/*!40000 ALTER TABLE `order_fixed_prices` ENABLE KEYS */;
UNLOCK TABLES;
