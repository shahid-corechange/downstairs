...
--
-- Dumping data for table `cashier_attendances`
--

LOCK TABLES `cashier_attendances` WRITE;
/*!40000 ALTER TABLE `cashier_attendances` DISABLE KEYS */;
/*!40000 ALTER TABLE `cashier_attendances` ENABLE KEYS */;
UNLOCK TABLES;
