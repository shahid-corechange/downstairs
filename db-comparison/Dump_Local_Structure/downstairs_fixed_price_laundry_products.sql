...
--
-- Table structure for table `fixed_price_laundry_products`
--

DROP TABLE IF EXISTS `fixed_price_laundry_products`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `fixed_price_laundry_products` (
...
--
-- Dumping data for table `fixed_price_laundry_products`
--

LOCK TABLES `fixed_price_laundry_products` WRITE;
/*!40000 ALTER TABLE `fixed_price_laundry_products` DISABLE KEYS */;
/*!40000 ALTER TABLE `fixed_price_laundry_products` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-10-27  7:59:28
