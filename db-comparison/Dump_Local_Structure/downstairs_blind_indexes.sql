...
--
-- Table structure for table `blind_indexes`
--
...
--
-- Dumping data for table `blind_indexes`
--

LOCK TABLES `blind_indexes` WRITE;
/*!40000 ALTER TABLE `blind_indexes` DISABLE KEYS */;
/*!40000 ALTER TABLE `blind_indexes` ENABLE KEYS */;
UNLOCK TABLES;
