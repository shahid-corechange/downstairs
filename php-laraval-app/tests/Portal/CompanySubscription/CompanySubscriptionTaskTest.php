...
class CompanySubscriptionTaskTest extends TestCase
{
    public function testCanCreateCompanySubscriptionTask(): void
    {
        ...
        $response = $this->actingAs($this->admin)
            ->post("/companies/subscriptions/{$subscription->id}/tasks", $data);
    ...
    public function testCanUpdateCompanySubscriptionTask(): void
    {
        $subscription = Subscription::first();
        $subscription->tasks()->delete();
        ...
        $response = $this->actingAs($this->admin)
            ->patch("/companies/subscriptions/{$subscription->id}/tasks/{$task->id}", $data);
    ...
    public function testCanNotUpdateCompanySubscriptionTaskIfNotFound(): void
    {
        $subscription = Subscription::first();
        $data = [
            'nameSvSe' => 'Prenumerationsuppgift 1',
        ...
        $response = $this->actingAs($this->admin)
            ->patch("/companies/subscriptions/{$subscription->id}/tasks/1000", $data);
    ...
    public function testCanDeleteCompanySubscriptionTask(): void
    {
        $subscription = Subscription::first();
        $subscription->tasks()->delete();
        ...
        $response = $this->actingAs($this->admin)
            ->delete("/companies/subscriptions/{$subscription->id}/tasks/{$task->id}");
    ...
    public function testCanNotDeleteCompanySubscriptionTaskIfNotFound(): void
    {
        $subscription = Subscription::first();

        $response = $this->actingAs($this->admin)
            ->delete("/companies/subscriptions/{$subscription->id}/tasks/1000");
