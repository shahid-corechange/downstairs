...
class FixedPriceRowResponseDTO extends BaseData
{
    ...
    public static function fromModel(FixedPriceRow $fixedPriceRow): self
    {
        return new self(
            Lazy::create(fn () => $fixedPriceRow->id)->defaultIncluded(),
            Lazy::create(fn () => $fixedPriceRow->fixed_price_id)->defaultIncluded(),
