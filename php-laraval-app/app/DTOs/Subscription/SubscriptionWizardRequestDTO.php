...
class SubscriptionWizardRequestDTO extends BaseData
{
    ...
    public static function rules(): array
    {
        ...
        return [
            ...
            'customer_id' => [
                'numeric',
                Rule::exists('customers', 'id')->where('membership_type', 'private'),
            ],
            'service_id' => [
                'required',
                'numeric',
                Rule::exists('services', 'id')->where('membership_type', 'private'),
            ],
            'addon_ids' => 'array',
