...
namespace App\Http\Controllers\CustomerDiscount;
...
class CustomerDiscountController extends BaseUserController
{
    use ResponseTrait;
    ...
    public function index(): Response
    {
        ...
        return Inertia::render('Customer/Discount/index', [
    ...
    public function store(CreateCustomerDiscountRequestDTO $request): RedirectResponse
    {
        ...
        return back()->with('success', __('customer discount created successfully'));
    }
    ...
    public function update(
        ...
        return back()->with('success', __('customer discount updated successfully'));
    }
    ...
    public function destroy(CustomerDiscount $customerDiscount): RedirectResponse
    {
        ...
        return back()->with('success', __('customer discount deleted successfully'));
    }
    ...
    public function restore(CustomerDiscount $customerDiscount): RedirectResponse
    {
        ...
        return back()->with('success', __('customer discount restored successfully'));
    }
}
