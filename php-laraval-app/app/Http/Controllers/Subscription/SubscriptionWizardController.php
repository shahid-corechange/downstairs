...
class SubscriptionWizardController extends BaseUserController
{
    ...
    public function index(): Response
    {
        ...
        return Inertia::render('Subscription/Wizard/index', [
            'users' => $this->subscriptionView->getUsers(MembershipTypeEnum::Private()),
     ...
     */
    public function store(SubscriptionWizardRequestDTO $request)
    {
