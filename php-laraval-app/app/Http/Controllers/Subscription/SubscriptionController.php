...
class SubscriptionController extends Controller
{
    ...
    public function index(): Response
    {
        $queries = $this->getQueries(
            filter: [
                'user_roles_name_eq' => 'Customer',
                'customer_membershipType_eq' => MembershipTypeEnum::Private(),
            ],
            defaultFilter: [
                'deletedAt_eq' => 'null',
            ],
        ...
        return Inertia::render('Subscription/Overview/index', [
            ...
            'services' => $this->subscriptionView->getServices(MembershipTypeEnum::Private()),
        ]);
    }
    ...
    {
        if (! $subscription->user->hasRole('Customer') ||
            $subscription->customer->membership_type !== MembershipTypeEnum::Private()) {
    ...
    public function update(UpdateSubscriptionRequestDTO $request, Subscription $subscription)
    {
        ...
        DB::transaction(
            function () use (
                ...
                $this->subscriptionUpdate->setFixedPrice($request, $subscription, $totalRawPrice, true);
            }
        );
